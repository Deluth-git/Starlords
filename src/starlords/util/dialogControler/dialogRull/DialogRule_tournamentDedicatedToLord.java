...
public class DialogRule_tournamentDedicatedToLord  extends DialogRule_Base {
    boolean feast;
    public DialogRule_tournamentDedicatedToLord(boolean feast){
        this.feast = feast;
    }
    ...
    public boolean condition(Lord lord) {
        ...
        return feast == lord.isDedicatedTournament();
    }
}
