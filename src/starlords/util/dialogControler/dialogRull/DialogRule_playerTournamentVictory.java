...
public class DialogRule_playerTournamentVictory extends DialogRule_Base {
    boolean feast;
    public DialogRule_playerTournamentVictory(boolean feast){
        this.feast = feast;
    }
    ...
    public boolean condition(Lord lord) {
        ...
        return feast == currentFeast.getTournamentWinner().isPlayer();
    }
