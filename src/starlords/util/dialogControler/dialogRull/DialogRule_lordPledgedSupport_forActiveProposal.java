...
public class DialogRule_lordPledgedSupport_forActiveProposal extends DialogRule_Base {
    boolean feast;
    public DialogRule_lordPledgedSupport_forActiveProposal(boolean feast){
        this.feast = feast;
    }
