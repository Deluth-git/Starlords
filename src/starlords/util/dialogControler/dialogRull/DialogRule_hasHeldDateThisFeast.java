...
public class DialogRule_hasHeldDateThisFeast extends DialogRule_Base {
    boolean feast;
    public DialogRule_hasHeldDateThisFeast(boolean feast){
        this.feast = feast;
    }
    ...
    public boolean condition(Lord lord) {
        ...
        return feast == currentFeast.isHeldDate();
    }
}
